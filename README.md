...
**当前为 0.2.0 早期预览版**，已提供智能保存、字体对照、创作换算和色彩工具。参考图、项目管理、批量交付与音视频处理正在规划，尚未实现。

[**下载 Windows 0.2.0 预览版**](https://github.com/Muamu925/creative-toolbox/releases/download/v0.2.0/CreativeToolbox-0.2.0-Windows-x64.zip) · [所有下载 / macOS 实验版](https://github.com/Muamu925/creative-toolbox/releases/tag/v0.2.0) · [English](README.en.md) · [功能路线](docs/FEATURE_ROADMAP.md)
...
| **字体与文字** | 本机双字体对照、自定义预览文案、字号与粗体调整、字体名称复制 | 对比标题与正文字体效果 |
...
2. 按当前任务进入「字体对照」「创作换算」或「配色工作台」，输入文案、数值或图片即可开始使用。
...
| **参考与项目** | 可置顶参考图画板、项目规格卡、目录与参考资料入口 |
| **素材与交付** | 批量重命名预览和撤销、图片多尺寸导出、联系表、交付清单 |
| **视频与动效** | 媒体信息、时码与帧数换算、抽帧，后续再做媒体转换 |
| **音乐与声音** | Tap Tempo、小节时长、音高与频率换算、音频规格检查 |
| **文字与效率** | 字体收藏、排版样张、文案整理、常用文本片段 |

希望这些模块共享项目规格、素材和导出设置，让一个工具的结果能被另一个工具直接使用。详细范围与验收思路见 [功能地图](docs/FEATURE_ROADMAP.md) 和 [下一阶段方案](docs/NEXT_STAGE_SPEC.md)。
