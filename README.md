...
**当前为 0.5.0 早期预览版**，已提供首页、工具搜索与收藏，以及智能保存、字体管理与对照、创作换算和色彩工具。新增图片收集、标签与来源整理、搜索、单图置顶和素材库备份。多图参考板、项目管理、批量交付与音视频处理尚未实现。

[**下载 Windows 0.5.0 预览版**](https://github.com/Muamu925/creative-toolbox/releases/download/v0.5.0/CreativeToolbox-0.5.0-Windows-x64.zip) · [所有下载 / macOS 实验版](https://github.com/Muamu925/creative-toolbox/releases/tag/v0.5.0) · [English](README.en.md) · [功能路线](docs/FEATURE_ROADMAP.md)
...
| **图片素材库** | PNG / JPEG 导入、拖放和主动粘贴；待整理、标签、来源、搜索、置顶参考、回收站与备份恢复 | 收下参考图，创作时重新找回 |
...
| **个人资源库** | 集合、素材关联提色、跨资源检索；连接个人配色和字体资料 |
...
入口与基础第一版已完成，图片素材库已交付第一步；下一步是 **完善资料关联 → 组合项目与交付**。这些模块将共享资源引用与项目规格，同时保留直接打开小工具的方式。实施顺序、架构与验收见 [整体架构与发展方案](docs/ARCHITECTURE_PLAN.md)；全部候选能力见 [功能地图](docs/FEATURE_ROADMAP.md)。
...
当前有 106 项自动化测试，覆盖保存规则、字体整理、配色持久化、悬浮同步、换算、工具入口与故障降级，以及素材收集、回收站、备份校验和独立恢复。自动化测试不能代替所有创作软件的真实兼容性验证。
